...
export const en: Record<keyof typeof ru, string> = {
  'join.emailPh': 'Email',
  'join.passPh': 'Password',
  'join.citizen': 'Citizen',
  'join.cop': 'Police officer',
  'join.go': 'Play',
  'join.needEmail': 'Enter email',
  'join.badPassword': 'Wrong password',
  'join.weakPassword': 'Password min 4 chars',
  'join.badVersion': 'Refresh the page (new server version)',
  'join.accountOnline': 'Account already in game',
  'join.banned': 'Account banned',
  'join.full': 'Server is full (100/100) or unavailable — try later',
  'chars.title': 'Choose character',
  'chars.namePh': 'New character nick',
  'chars.play': 'Play',
  'chars.delete': 'Delete',
  'chars.deleteConfirm': 'Delete {name}? Progress is lost forever.',
  'chars.copFull': 'Police force is full — citizen available',
  'chars.slotsFull': 'All slots taken (8/8)',
  'chars.err.nick_bad': 'Nick must be 1-16 chars',
  'chars.err.nick_taken': 'This nick is taken',
  'chars.err.role_bad': 'Invalid role',
  'chars.err.slots_full': 'All slots taken (8/8)',
  'chars.err.cop_full': 'Police force is full — citizen available',
  'chars.err.not_found': 'Character not found',
  'chars.err.banned': 'Character banned',
  'chars.err.banned_perm': 'Character banned permanently',
  'chars.err.generic': 'Error — try again',
